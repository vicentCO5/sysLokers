...
<div class="row">
	<div class="col-xs-12">
		<div class="page-header"><h1>Ventas</h1>
		</div>
		<!-- /.page-header -->
		<div class="row">
			<div class="alert alert-info">
				<button class="btn btn-sm btn-primary" id="importVentas">
					<i class="ace-icon glyphicon glyphicon-upload bigger-110"></i>
					Importar Ventas
				</button>
				<button class="btn btn-sm btn-success" id="searchperiodos">
					<i class="ace-icon glyphicon glyphicon-search bigger-110"></i>
					Consultar
				</button>
				<button class="btn btn-sm btn-danger" id="deletesVtas"
					onclick="deleteallsell()">
					<i class="ace-icon glyphicon glyphicon-trash bigger-110"></i>
					Eliminar
				</button>
				<button class="btn btn-sm btn-danger" id="deletesVtasxperiodo"
...
<script>
	...
	$(function() {
		//////////////////		
		$("#importVentas").click(function() {
			$.ajax({
				url : '${pageContext.request.contextPath}/getimportventas',
				dataType : 'html',
				success : function(data) {
					$("#modal-body").html(data);
					$("#modal-header").html("<h4>Importar Ventas</h4>");
					$('#modalaps').modal('show');
				},
				error : function(data) {
